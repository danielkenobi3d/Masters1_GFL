...
class RigByped(rigBase.RigBase):
    def __init__(self, *args, **kwargs):
        ...
        self.ear_root = ['{}_ear00_reference_pnt', '{}_ear01_reference_pnt', '{}_ear02_reference_pnt', '{}_ear03_reference_pnt', '{}_ear04_reference_pnt']
    ...
    def build(self):
        ...
        l_ear_root_points = [each.format('L') for each in self.ear_root]

        self.l_ear.create_point_base(*l_ear_root_points, orient_type = 'point_orient')
        self.l_ear.set_parent(self.neck_head, create_hierarchy_joints=True, output_joint_rig=self.rig_output)
        r_ear_root_points = [each.format('R') for each in self.ear_root]
        self.r_ear.create_point_base(*r_ear_root_points, orient_type = 'point_orient')
